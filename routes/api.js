...
router.get("/ytplay", async(req, res, next) => {
    ...
    if(listkey.includes(apikey)){
     ...
     fetch(encodeURI(`https://api.vhtear.com/ytmp3?query=${query}&apikey=MiraCans`))
        .then(response => response.json())
        .then(data => {
...
router.get("/ytplay2", async(req, res, next) => {
    ...
    if(listkey.includes(apikey)){
     ...
     fetch(encodeURI(`https://lolhuman.herokuapp.com/api/ytplay2?apikey=MiraCans&query=${query}`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/quotes/dilan', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){

       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/quotes/dilan?apikey=MiraCans`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/quotesnime', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){

       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/quotesnime?apikey=MiraCans`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/quotesimage', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){

  let hasil = 'https://lolhuman.herokuapp.com/api/random/quotesimage?apikey=MiraCans' 
  data = await fetch(hasil).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/quotes.jpg', data)
  res.sendFile(__path +'/tmp/quotes.jpg')
  } else {
    res.json(loghandler.invalidKey)
  }
});
...
router.get('/random/katabijak', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/katabijak?apikey=MiraCans`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/pantun', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/pantun?apikey=MiraCans`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/bucin', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){

       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/bucin?apikey=MiraCans`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/random/nama', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){

       fetch(encodeURI(`https://lolhuman.herokuapp.com/api/random/nama?apikey=MiraCans`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/quotes/muslim', async (req, res, next) => {
        var Apikey = req.query.apikey
